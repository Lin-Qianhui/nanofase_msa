...
module BedSedimentLayerModule
    ...
    type, public, extends(AbstractBedSedimentLayer) :: BedSedimentLayer
      contains
        procedure, public :: create => createBedSedimentLayer
        procedure, public :: destroy => destroyBedSedimentLayer
        procedure, public :: addSediment => addSedimentBedSedimentLayer
        procedure, public :: removeSediment => removeSedimentBedSedimentLayer
        procedure, public :: clearAll => clearAllBedSedimentLayer
        procedure, public :: repMass => reportMassesToConsoleBedSedimentLayer
    end type
  ...
  contains
    ...
    !! </ul>
    function createBedSedimentLayer(Me, l) result(r)
        ...
        tr = trim(Me%name) // &
            "%createBedSedimentLayer%colFineSediment"           ! trace message
        ...
        tr = trim(Me%name) // &
            "%createBedSedimentLayer%C_f_l"                     ! trace message
        ...
        tr = trim(Me%name) // &
            "%createBedSedimentLayer%C_w_l"                     ! trace message
        ...
        tr = trim(Me%name) // &
            "%createBedSedimentLayer%pd_comp"                   ! trace message
    ...
    function destroyBedSedimentLayer(Me) result(r)
        ...
        ! -------------------------------------------------------------------------------
        tr = trim(Me%name) // &
            "%destroyBedSedimentLayer%colFineSediment"          ! trace message
        ...
        tr = trim(Me%name) // &
            "%destroyBedSedimentLayer%pd_comp"                  ! trace message
        ...
        tr = trim(Me%name) // &
            "%destroyBedSedimentLayer%C_f_l"                    ! trace message
        ...
        tr = trim(Me%name) // &
            "%destroyBedSedimentLayer%C_w_l"                    ! trace message
    ...
    function addSedimentBedSedimentLayer(Me, S, F) result(r)
        class(BedSedimentLayer) :: Me                           !! The `BedSedimentLayer` instance
    ...
    function removeSedimentBedSedimentLayer(Me, S, G, H) result(r)
        class(BedSedimentLayer) :: Me                           !! The `BedSedimentLayer` instance
        integer, intent(in) :: S                                 !! The particle size class
    ...
    !! **Function outputs/outcomes**                            
    !! 
    subroutine reportMassesToConsoleBedSedimentLayer(me)
        class(BedSedimentLayer) :: me                          !! The `BedSedimentLayer` instance
